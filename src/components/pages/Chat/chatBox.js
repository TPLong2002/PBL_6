...
export default function ChatBox ({receivedId,chatId, message,image,firstName,lastName ,stompClient}) {
  ...
  return (
    <div className="flex flex-col w-full mx-2 h-full rounded-lg shadow-lg" key={receivedId}>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        >
          {message!==undefined? message.map((message, index) => {
            console.log(message)
      return message.senderId != userId ? (
        <div className="flex flex-col">
          <p className="flex justify-start mb-1 text-xs text-gray-400">{format(new Date(message.time) ,'dd-MM-yyyy HH:mm:ss')}</p>
        ...
        <div className="flex flex-col">
           <p className="flex justify-end mb-1 text-xs text-gray-400">{format(new Date(message.time) ,'dd-MM-yyyy HH:mm:ss')}</p>
