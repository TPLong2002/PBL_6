...
export default function ChatBox({ chatUser }) {
  ...
  const handleSendMessage = () => {
    if (message.trim() !== "") {
      ...
      const newMessage = {
        sender: "You", // Đây có thể là tên của người dùng hiện tại
        text: message,
      };
      setChat([...chat, newMessage]);

      // Xóa tin nhắn đã ghi trong ô nhập
      setMessage("");
    }
  };

  return (
    <div className="flex flex-col w-full mx-8 h-full rounded-lg shadow-lg">
